...
var NumberColumn = memo(function (_a) {
    ...
    useEffect(function () { return setColumnToNumber(digit); }, [digit, setColumnToNumber]);
    return (React.createElement("div", { className: 'ticker-column-container', ref: columnContainer, style: {
        ...
        React.createElement(motion.div, { animate: { x: 0, y: position }, className: "ticker-column ".concat(animationClass), onAnimationComplete: function () { return setAnimationClass(""); } }, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0].map(function (num) { return (React.createElement("div", { key: num, className: 'ticker-digit' },
...
var AnimatedCounter = function (_a) {
    var _b = _a.value, value = _b === void 0 ? 0 : _b, _c = _a.fontSize, fontSize = _c === void 0 ? '18px' : _c, _d = _a.color, color = _d === void 0 ? 'black' : _d, _e = _a.incrementColor, incrementColor = _e === void 0 ? '#32cd32' : _e, _f = _a.decrementColor, decrementColor = _f === void 0 ? '#fe6862' : _f, _g = _a.includeDecimals, includeDecimals = _g === void 0 ? true : _g;
    ...
    return (React.createElement(motion.div, { layout: true, className: 'ticker-view' }, numArray.map(function (number, index) {
        return number === "." ? (React.createElement(DecimalColumn, { key: index, fontSize: fontSize, color: color })) : (React.createElement(NumberColumn, { key: index, digit: number, delta: delta, color: color, fontSize: fontSize, incrementColor: incrementColor, decrementColor: decrementColor, includeDecimals: includeDecimals }));
    })));
};
