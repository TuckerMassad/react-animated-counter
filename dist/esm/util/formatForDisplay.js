...
var formatForDisplay = function (number, includeDecimals, decimalPrecision, includeCommas) {
    ...
    var numberToFormat = includeCommas ? parseFloat(parsedNumber).toLocaleString(undefined, { minimumFractionDigits: includeDecimals ? decimalPrecision : 0 }) : parsedNumber;
